...
export const FormWrapper = styled(Form)<ThemeProps>`
  width: 100%;
  display: flex;
  flex-direction: column;
  gap: 16px;
...
export const EventTypeSelectorWrapper = styled.div`
  width: 450px;
  display: flex;
...
export const EventTypeOption = styled.div<ButtonTypeProps>`
  background-color: ${({ theme }) => (theme === 'dark' ? COLORS.black[800] : COLORS.white[300])};
